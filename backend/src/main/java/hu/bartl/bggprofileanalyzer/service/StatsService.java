...
import hu.bartl.bggprofileanalyzer.stats.PlayerCountStatCalculator;
...
public class StatsService {
    ...
    private final PlayerCountStatCalculator playerCountStatCalculator;
    ...
    public UserStats createStats(String userId) {
        ...
        return UserStats.builder()
            ...
            .playerCountPopularities(playerCountStatCalculator.calculate(games))
            .build();
    }
}
